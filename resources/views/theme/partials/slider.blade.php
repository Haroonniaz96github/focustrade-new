            ...
            <div class="carousel-item" style="background-image: url(public/front_end/assets/img/slide/image003.jpg)">
                <div class="carousel-container">
                    <div class="container">
                        ...
                        <p class="animate__animated animate__fadeInUp">Currencies being traded are listed in pairs, such as USD/CAD, EUR/USD, or USD/JPY. These represent the U.S. dollar (USD) versus the Canadian dollar (CAD), the Euro (EUR) versus the USD, and the USD versus the Japanese Yen (JPY).</p>
                        <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item" style="background-image: url(public/front_end/assets/img/slide/image005.jpg)">
                <div class="carousel-container">
                    <div class="container">
                        ...
                        <p class="animate__animated animate__fadeInUp">In the Forex market, currencies trade in lots called micro, mini, and standard lots. A micro lot is 1,000 units of a given currency, a mini lot is 10,000, and a standard lot is 100,000.</p>
                        <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
                    </div>
                </div>
            </div>
