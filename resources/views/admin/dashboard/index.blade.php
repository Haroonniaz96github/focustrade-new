                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">$161.00</h3>
                                       <p class="counter text-right m-t-15">$0.00</p>
                                        </li>
                                    <li class="col-middle">
                                        <h4>G-Bonus</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12  b-0">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                         <h3 class="counter text-right m-t-15">$11625.00</h3>
                                        <p class="counter text-right m-t-15">$0.00</p>
                                    <li class="col-middle">
                                        <h4>Total Sales</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12 row-in-br  b-r-none">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                       <h3 class="counter text-right m-t-15">$0.00</h3>
                                        <p class="counter text-right m-t-15">$0.00</p>
                                    <li class="col-middle">
                                        <h4>T-withdrawal</h4>
                                        <div class="progress">
