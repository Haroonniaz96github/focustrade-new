                            ...
                            <div class="change_pass_field float_left">  
                                <div class="change_field">
                                    <label>Current Password</label>
                                       ...
                                       class="form-control @error('password') is-invalid @enderror" autofocus id="password" value="">
                                       @error('password')
                                ...
                                <div class="change_field">
                                    <label>New Password</label>
                                       ...
                                       class="form-control @error('new_password') is-invalid @enderror" id="new_password" value="">
                                       @error('new_password')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                        <div class="clearfix"></div>
                                ...
                                <div class="change_field">
                                    <label>Re-enter New Password</label>
                                       ...
                                       class="form-control @error('curr_password_c') is-invalid @enderror" required id="new_password_confirmation">
