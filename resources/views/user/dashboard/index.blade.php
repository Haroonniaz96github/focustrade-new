              ...
              <a href="#">dashboard</a>
                <ul class="cd-secondary-dropdown icon_menu is-hidden">
				   ...
				   <li>
					...
					<li>
                      <a href="#tml">change pin</a>
					</li>
					<li>
                      <a href="#ory.html">deposit history</a>
                  </li>
					<li>
                      <a href="#.html">deposit list</a>
                  </li>
					<li>
                      <a href="#tory.html">earnings history</a>
                  </li>
					<li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-12 col-lg-12 col-sm-12 col-12">
                                    <ul class="profile_list">
                                        <li><span class="detail_left_part">Referral ID
</span> <span class="detail_right_part">{{ Auth::user()->sponser_id }}
</span>
                                        </li>
                                        <li><span class="detail_left_part">first name
 </span> <span class="detail_right_part">{{ Auth::user()->first_name }}
</span>
                                        </li>
                                        <li><span class="detail_left_part">Last Name</span> <span class="detail_right_part">{{ Auth::user()->last_name }}
</span>
                                        </li>
                                        <li><span class="detail_left_part">Your Email Address</span> <span class="detail_right_part">{{ Auth::user()->email }}</span>
                                        </li>
                                        ...
                                        <!--</li>-->
                                        <li><span class="detail_left_part">Paypal</span> <span class="detail_right_part">{{ Auth::user()->email }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xl-6 col-md-12 col-lg-12 col-sm-12 col-12">
